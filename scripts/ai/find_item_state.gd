...
var item_traits_to_find: Array[GameItem.ItemTrait]
...
func execute(controller: AiActorController):
	var closest_item_with_trait = controller.world.get_closest_item_with_traits(controller.actor.global_position, item_traits_to_find)
...
func get_name() -> String:
	...
	for item_trait: GameItem.ItemTrait in item_traits_to_find:
